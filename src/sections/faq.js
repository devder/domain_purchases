...
const data = [
  {
    ...
    ans: `We make it easy to move to production. Simply contact us and we'll move your hosting account from any other provider, regardless of the control panel. If at anytime your website is down for more than 0.1% result`,
  },
  {
    id: 2,
    ques: "What are some tips when choosing a name?",
    ans: `Get your website delivered live and scale infinitely`,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    ans: `Dev Derick knows that you need more than a great product to have a great brand. Hear his thoughts & score a peek at our wagon.`,
  },
];
...
const Faq = () => {
  return (
    <Box as="section" id="faq" sx={styles.section}>
      <Container>
        <SectionHeading sx={styles.heading} slogan="Get yours question answer" title="Frequantly asked question" />
