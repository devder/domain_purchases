...
const data = [
  {
    ...
    contents: (
      <div>Website speed can slow or grow your business. Delight your visitors with a lightning fast website.</div>
    ),
  },
  {
    ...
    contents: (
      <div>
        Start your website with an automatic 1-click installation. The backend is powered by LiteSpeed caching and
        advanced optimization to ensure your websites are fast, reliable and secure.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        Different projects require different technologies. Pick a plan that matches your current needs, then upgrade and
...
const PremiumFeature = () => {
  return (
    <Box as="section" sx={styles.section}>
      <Box as="figure" sx={{ ...styles.illustration, background: `url(${ipad}) no-repeat` }} />
      <Container sx={styles.container}>
        <Box sx={styles.accordionGroup}>
          <SectionHeading
            ...
            description="Build an incredible workplace and grow your business with Sample's all-in-one platform with amazing contents."
          />
