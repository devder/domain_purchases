...
const data = [
  {
    ...
    thumbnail: thumb1,
    excerpt: `Derick Fronge knows that you need more than a great product to have a great brand with new features.`,
    slug: `#Learn more`,
  },
  {
    id: 2,
...
const Blog = () => {
  return (
    <Box as="section" id="blog" sx={styles.section}>
      <Container>
        <SectionHeading sx={styles.heading} slogan="Latest newsfeed" title="Our recent blog post that updated" />
